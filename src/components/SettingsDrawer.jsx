...
export default function SettingsDrawer({onClose}){
  ...
  const trackedCount = transactions ? transactions.length : 0
      ...
      <div className="modal profile-panel">
        <div className="profile-header">
          <div style={{display:'flex',alignItems:'center',gap:12}}>
            ...
            <div>
              <h3 style={{margin:0}}>Jordan Doe · Product Manager</h3>
              <div style={{display:'flex',flexDirection:'column',gap:6}}>
                <div className="small">Managing personal and business expenses since 2021</div>
                <div style={{display:'flex',gap:8,alignItems:'center',marginTop:6}}>
                  <div className="chip">Premium</div>
                  <div className="chip">Since 2021</div>
                  <div className="small" style={{marginLeft:8,opacity:0.95}}>{`Tracked ${trackedCount} transactions`}</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div style={{display:'grid',gridTemplateColumns:'1fr',gap:12}}>
            <div>
              ...
              <div style={{display:'grid',gridTemplateColumns:'repeat(2,1fr)',gap:12,alignItems:'start'}}>
                ...
                <div>
                  <label className="small">Accent</label>
                  <div style={{display:'flex',gap:8,alignItems:'center'}}>
              ...
              <div style={{display:'grid',gridTemplateColumns:'repeat(2,1fr)',gap:12,alignItems:'center'}}>
                <div style={{display:'flex',flexDirection:'column',gap:8}}>
                  ...
                  <label style={{display:'flex',alignItems:'center',gap:8}}>
                    ...
                    <span style={{marginLeft:8,color:'var(--muted)',fontSize:'0.8rem'}}>Appearance</span>
                  </label>
                </div>

                <div style={{display:'flex',flexDirection:'column',gap:6}}>
                  <label className="small">Profile glow</label>
                  <input type="range" min={0} max={100} defaultValue={40} />
                  <div className="small" style={{color:'var(--muted)',marginTop:4}}>Controls the intensity of the highlight around your profile card.</div>
                </div>
              </div>
            </div>
          </div>
